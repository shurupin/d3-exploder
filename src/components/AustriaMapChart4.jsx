...
export default class AustriaMapChart4 extends Component {
  constructor(props) {
    super(props);
    ...
    d3.json(
      ...
      .then(function (at) {
        ...
        function addButton(text, callback) {
          d3.select('#buttons-austria-map-chart-4')
            .append('button')
            .text(text)
            .on('click', function () {
  ...
  render() {
    return (
      <>
        <div id="buttons-austria-map-chart-4" />
        <div id="austria-map-chart-4" ref={this.mapRef} />
      </>
    );
  }
}
