...
export default class BelgiumMapChart8 extends Component {
  constructor(props) {
    super(props);
    ...
    d3.json(
      ...
      .then(function (bg) {
        ...
        function addButton(text, callback) {
          d3.select('#buttons-belgium-map-chart-8')
            .append('button')
            .text(text)
            .on('click', function () {
  ...
  render() {
    return (
      <>
        <div id="buttons-belgium-map-chart-8" />
        <div id="belgium-map-chart-8" ref={this.mapRef} />
      </>
    );
  }
}
