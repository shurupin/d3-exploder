...
export default class GermanyMapChart4 extends Component {
  constructor(props) {
    super(props);
    ...
    d3.json(
      ...
      .then(function (ge) {
        ...
        function addButton(text, callback) {
          d3.select('#buttons-germany-map-chart-4')
            .append('button')
            .text(text)
            .on('click', function () {
  ...
  render() {
    return (
      <>
        <div id="buttons-germany-map-chart-4" />
        <div id="germany-map-chart-4" ref={this.mapRef} />
      </>
    );
  }
}
