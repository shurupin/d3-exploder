...
export default class GermanyMapChart8 extends Component {
  constructor(props) {
    super(props);
  ...
  drawExploder = (myExploder) => {
    ...
    d3.json(
      ...
      .then(function (ge) {
        const state_features = topojson.feature(ge, ge.objects.DEU_adm2).features;
        ...
        const states = g
          ...
          .data(
            state_features.filter(function (d) {
              return d.properties.ID_1 == '754' || d.properties.ID_1 == '768';
            }),
          )
          .enter()
          .append('path')
        ...
        function addButton(text, callback) {
          d3.select('#buttons-germany-map-chart-8')
            .append('button')
            .text(text)
            .on('click', function () {
  ...
  render() {
    return (
      <>
        <div id="buttons-germany-map-chart-8" />
        <div id="germany-map-chart-8" ref={this.mapRef} />
      </>
    );
  }
}
