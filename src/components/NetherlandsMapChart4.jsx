...
export default class NetherlandsMapChart4 extends Component {
  constructor(props) {
    super(props);
  ...
  drawExploder = (myExploder) => {
    ...
    const svg = d3
      .select('#netherlands-map-chart-4')
      .append('svg')
    ...
    d3.json(
      ...
      .then(function (nl) {
        ...
        function addButton(text, callback) {
          d3.select('#buttons-netherlands-map-chart-4')
            .append('button')
            .text(text)
            .on('click', function () {
  ...
  render() {
    return (
      <>
        <div id="buttons-netherlands-map-chart-4" />
        <div id="netherlands-map-chart-4" ref={this.mapRef} />
      </>
    );
  }
}
